...
## Architecture
- **Content Council**: Hook Analyst, Emotion/Storytelling Analyst, Production Quality Analyst
...
## Pipeline
```
Input → Preprocess → Content Council (2 debate rounds) → Market Council (2 debate rounds)
...
- **Sonnet**: All 6 judge agents (evaluation, scoring, debate)
